...
module vga_sync
	...
	// mod-2 counter to generate 25 MHz pixel tick from 50 MHz
	reg pixel_reg;
	wire pixel_next;
	wire pixel_tick;
	...
	assign pixel_next = ~pixel_reg; // toggle pixel_reg 
	
	assign pixel_tick = pixel_reg; // assert tick 1/2 of the time
